...
export const translations = {
  bs: {
    ...
    about: {
      ...
      uiFocus: 'UI/UX Fokus',
      uiFocusDesc: 'Kreativnost i funkcionalnost u savršenoj harmoniji',
      performance: 'Brze Performanse',
      performanceDesc: 'Optimizujem aplikacije za maksimalnu brzinu',
  ...
  en: {
    ...
    about: {
      ...
      uiFocus: 'UI/UX Focus',
      uiFocusDesc: 'Creativity and functionality in perfect harmony',
      performance: 'Fast Performance',
      performanceDesc: 'I optimize applications for maximum speed',
      cvTitle: 'Curriculum Vitae',
  ...
  de: {
    ...
    about: {
      ...
      uiFocus: 'UI/UX Fokus',
      uiFocusDesc: 'Kreativität und Funktionalität in perfekter Harmonie',
      performance: 'Schnelle Leistung',
      performanceDesc: 'Ich optimiere Anwendungen für maximale Geschwindigkeit',
      cvTitle: 'Lebenslauf',
