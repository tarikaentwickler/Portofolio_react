...
export const translations = {
  bs: {
    ...
    about: {
      ...
      uiFocusDesc: 'React, Node.js, MongoDB',
      performance: 'Career Goal',
      performanceDesc: 'Fachinformatiker Ausbildung & IT karijera',
  ...
  en: {
    ...
    about: {
      ...
      cleanCode: 'Web Development',
      cleanCodeDesc: 'Frontend and backend applications',
      uiFocus: 'Modern Technologies',
      uiFocusDesc: 'React, Node.js, MongoDB',
      performance: 'Career Goal',
      performanceDesc: 'Fachinformatiker training & IT career',
      cvTitle: 'Curriculum Vitae',
  ...
  de: {
    ...
    about: {
      ...
      cleanCode: 'Web Development',
      cleanCodeDesc: 'Frontend und Backend Anwendungen',
      uiFocus: 'Moderne Technologien',
      uiFocusDesc: 'React, Node.js, MongoDB',
      performance: 'Karriere Ziel',
      performanceDesc: 'Fachinformatiker Ausbildung & IT Karriere',
      cvTitle: 'Lebenslauf',
